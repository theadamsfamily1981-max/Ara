...
Usage:
    # Start API server
    python -m ara.main api

    # Run training
    python -m ara.main train --backend tfan

    # Check system status
    python -m ara.main status

    # Interactive mode
    python -m ara.main interactive
"""
...
def print_status():
    ...
    for subdir in ['models', 'agents', 'training', 'api', 'configs', 'utils']:
