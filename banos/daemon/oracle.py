...
Usage:
    ...
    # → (PlanOption("PLAN C", "Focus on symbiotic debugging..."), 0.72)
...
"""
    ...
    def divine(
        ...
        self.log.info(f"🔮 ORACLE: Beginning divination (horizon={horizon})")
        ...
        self.log.info(f"🔮 ORACLE: Generated {len(plans)} plans")
        ...
        for p in plans:
            ...
            self.log.info(f"🔮 {p.label}: utility={util:.3f}")

        # Step 3: Calculate hope
        # Map utility to hope ∈ [0, 1]
        ...
        self.log.info(
            f"🔮 ORACLE: Selected {best_plan.label if best_plan else 'None'} "
